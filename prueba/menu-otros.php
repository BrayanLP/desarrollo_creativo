  ...
  <div class="container">
    <div class="nav-wrapper">
      ...
      <?php if ($the_query->have_posts()) : ?>
          ...
          <?php $logo2= get_field('logo2'); ?>
          <a class=" brand-logo" href="<?php echo site_url(); ?>" >
            <img width="280px" class="show-logo" src="<?php echo $logo2['url']; ?>" alt="<?php echo $logo2['title']; ?>" title="<?php echo $logo2['title']; ?>">
            <img width="200px" class="hide-logo" src="<?php echo $logo['url']; ?>" alt="<?php echo $logo['title']; ?>" title="<?php echo $logo['title']; ?>">
          </a>
          <?php endwhile; ?>
